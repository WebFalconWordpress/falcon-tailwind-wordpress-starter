<?php
/**
 * Genesis Blocks CTA Three section for Authority Collection.
 *
...
<div class=\"wp-block-genesis-blocks-gb-column gb-block-layout-column gb-is-vertically-aligned-center\"><div class=\"gb-block-layout-column-inner\"><!-- wp:image {\"align\":\"center\",\"id\":729,\"width\":380,\"sizeSlug\":\"large\",\"linkDestination\":\"none\",\"className\":\"is-style-gpb-border is-style-gpb-shadow\"} -->
<div class=\"wp-block-image is-style-gpb-border is-style-gpb-shadow\"><figure class=\"aligncenter size-large is-resized\"><img src=\"https://demo.studiopress.com/page-builder/authority/icons.jpg\" alt=\"\" class=\"wp-image-729\" width=\"380\"/></figure></div>
<!-- /wp:image -->
...
<h2 class=\"is-style-gpb-capital-text has-text-color\" style=\"color:#000cff;font-size:12px;line-height:1.2\">Free Resources. Free Membership. Instant Access!</h2>
<!-- /wp:heading -->

<!-- wp:heading {\"level\":3,\"style\":{\"typography\":{\"fontSize\":40,\"lineHeight\":\"1.2\"},\"color\":{\"text\":\"#111111\"}}} -->
<h3 class=\"has-text-color\" style=\"color:#111111;font-size:40px;line-height:1.2\">Join the Community</h3>
<!-- /wp:heading -->
...
<div class=\"wp-block-button\"><a class=\"wp-block-button__link has-text-color has-background no-border-radius\" style=\"background-color:#000cff;color:#ffffff\">Join Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
...
<!-- /wp:genesis-blocks/gb-columns -->",
	'name'       => esc_html__( 'Authority CTA Three', 'genesis-page-builder' ),
	'category'   => [
	...
	'keywords'   => [
		...
		esc_html__( 'authority cta three', 'genesis-page-builder' ),
	],
	'image'      => 'https://demo.studiopress.com/page-builder/authority/gpb_authority_section_cta_three.jpg',
];
