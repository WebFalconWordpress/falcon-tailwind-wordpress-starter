...
<div class="wp-block-group wp-block-query">
	...
	<div class="wp-block-query">
		...
		<!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|5"}},"layout":{"type":"grid","columnCount":3}} -->
			<!-- wp:post-featured-image {"isLink":true,"aspectRatio":"4/3","style":{"spacing":{"margin":{"bottom":"0"},"padding":{"bottom":"var:preset|spacing|2"}},"color":{"duotone":"unset"}}} /-->
			...
			<div class="flex flex-col items-start gap-2 pt-0 mt-2 wp-block-group flex-nowrap"><!-- wp:template-part {"slug":"post-meta","theme":"falcontwstarter"} /-->
				...
				<!-- wp:post-excerpt {"showMoreOnNewLine":false,"excerptLength":41,"style":{"spacing":{"margin":{"top":"var:preset|spacing|2","bottom":"var:preset|spacing|2"}}}} /-->
			</div>
			<!-- /wp:group -->
			<!-- /wp:post-template -->
		</div>
		...
		<!-- wp:spacer {"height":"var:preset|spacing|2","className":"m-0 p-0"} -->
		<div style="height:var(--wp--preset--spacing--2)" aria-hidden="true" class="p-0 m-0 wp-block-spacer"></div>
		<!-- /wp:spacer -->
